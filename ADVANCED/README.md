...
<p align="center">
    <img src="../img/spark_stages.jpg" alt="spark" width="600"/>
</p>
...
Также обязательно делимся примером из практики в стиле: на прошлом проекте делал join датасета с 10 млрд записей и маленькой таблицей-справочником. Ключ user_id был сильно перекошен: 70% данных приходилось на 5% пользователей.

**Решил проблему так:**

— Выделил тяжелых user_id в отдельный датасет.

— Для них применил соль с 200 подключами.

— Остальные данные обработал через broadcast join.
...
— ну и вообще, кэширую часто используемые данные (если это уместно)
...
<p align="center">
    <img src="../img/spark_join.jpg" alt="spark" width="600"/>
</p>
